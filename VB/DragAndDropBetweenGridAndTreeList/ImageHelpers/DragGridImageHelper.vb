            ...
            Try
                ...
                Using gView As Graphics = Graphics.FromImage(bmpView)
                    Using grView As XtraBufferedGraphics = XtraBufferedGraphicsManager.Current.Allocate(gView, New Rectangle(Point.Empty, bmpView.Size))
                        Dim color As Color = If(ri.Appearance.BackColor = System.Drawing.Color.Transparent, System.Drawing.Color.White, ri.Appearance.BackColor)
                        ...
                        DrawRow(args, ri)
                        grView.Graphics.FillRectangle(args.Cache.GetSolidBrush(System.Drawing.Color.Transparent), ri.Bounds)
                        grView.Render()
